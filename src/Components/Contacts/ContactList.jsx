                    ...
                    <div className="grid">
                        <div className="row">
                            <div className="col">
                                ...
                                <p className="fst-italic">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem nisi vel iure officiis doloremque numquam? Ipsam, recusandae illum quidem fuga dignissimos temporibus quis at ea doloremque architecto tempora. Debitis, nisi?</p>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-md-6">
                                <form className='row' >
                                    <div className="col">
                                        <div className="mb-2">
                                            <input type="text"  value={query.text} onChange={searchContacts} name="text"className='form-control' placeholder='Search Names' />
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="mb-2">
                                            <input type="subbmit" className='btn btn-outline-dark' value={'search'} />
                                        </div>
                                    </div>
                                </form>
                            </div>
